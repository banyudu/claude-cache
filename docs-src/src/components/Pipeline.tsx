...
const stages = [
  { label: 'Intercept', icon: '{}', desc: 'Hook captures Read, Write, Edit, Bash calls' },
  { label: 'Estimate', icon: '~=', desc: 'Calculate token cost from file size' },
  { label: 'Track', icon: '+=', desc: 'Add to cumulative session total' },
  { label: 'Decide', icon: '>>', desc: 'Pass, warn, or block the operation' },
]

const stageColors = ['var(--accent-blue)', 'var(--accent-amber)', 'var(--accent-purple)', 'var(--color-safe)']
    ...
    <section className="section">
      ...
      >
        ...
        <p className="section-subtitle">
          Every file operation passes through a 4-stage cost estimation pipeline.
        </p>
      </motion.div>
        ...
        <svg width="100%" height="40" viewBox="0 0 1000 40" preserveAspectRatio="none" style={{ display: 'block' }}>
          <defs>
            <linearGradient id="pathGrad" x1="0" y1="0" x2="1" y2="0">
              ...
              <stop offset="100%" stopColor="var(--color-safe)" />
            </linearGradient>
          </defs>
